...
export function PieChart({ data, width = 400, height = 300, className = '' }: ChartProps) {
...
export function BarChart({ data, width = 400, height = 300, className = '' }: ChartProps) {
  return (
    <div className={`bg-gray-100 rounded-lg flex items-center justify-center ${className}`} style={{ width, height }}>
      <div className="text-center">
...
export function LineChart({ data, width = 400, height = 300, className = '' }: ChartProps) {
  return (
    <div className={`bg-gray-100 rounded-lg flex items-center justify-center ${className}`} style={{ width, height }}>
      <div className="text-center">
